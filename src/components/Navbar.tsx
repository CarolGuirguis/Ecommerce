...
import { fetchcategoryproducts,fetchallproducts } from "../store/products/products.actions";
...
export const Navbar=() =>{
  ...
  const openc=cart['shown'] 
  const submitHandler= async (e: SyntheticEvent,category:string)=>{
    e.preventDefault();
            ...
            <div className="relative flex h-16 items-center justify-between">
              ...
              <div className="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
                <button
                  type="button"
                  onClick={()=>toggleCart()}
                  className="rounded-full bg-white-800 p-1 text-gray-400 hover:text-black "
                >
